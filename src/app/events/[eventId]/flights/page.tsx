  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href={`/events/${eventId}/squads`} className="bg-indigo-600 text-white px-3 py-1.5 rounded hover:bg-indigo-700 text-sm font-medium">
          Squad Planner →
        </Link>
      </div>

      <CreateFlightForm eventId={eventId} />

      <div className="mt-6">
        {flights.length === 0 ? (
          <p className="text-gray-500">No flights yet. Create one above.</p>
        ) : (
